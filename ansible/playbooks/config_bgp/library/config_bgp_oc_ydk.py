...
def config_bgp_ipv4(yang_repo="",
     ...
     if "router_id" in list(bgp.keys()):
         ...
         print("Router-id for BGP instance not specified")
         sys.exit(1)
     ...
     peer_group.config.peer_as = bgp["peer-as"]
     peer_group.transport.config.local_address = bgp["peer-group-local-address"]

     ipv4_afsf = peer_group.afi_safis.AfiSafi()
     ipv4_afsf.afi_safi_name = oc_bgp_types.IPV4UNICAST()
     ipv4_afsf.config.enabled = True
     peer_group.afi_safis.afi_safi.append(ipv4_afsf)
     ...
     ipv4_afsf = neighbor.afi_safis.AfiSafi()
     ipv4_afsf.afi_safi_name = oc_bgp_types.IPV4UNICAST()
     ipv4_afsf.config.enabled = True
     neighbor.afi_safis.afi_safi.append(ipv4_afsf)
